...
win_and_pooh(input('Введите ритм: '))
...
user_numbers = int(input('Это таблица умножения. Введите число до которго хотите вывести таблицу: '))
for i in range(1, user_numbers + 1):
     for j in range(i, i * user_numbers + 1, i):
         print(j, end='\t')
     print()
